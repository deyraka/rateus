  ...
  <div>
    ...
    <section class="missing">
      ...
      <div class="missing__content">
        <div class="missing__message message">
          <h1 class="message__title">404</h1>
          <p class="message__text">Mohon maaf. Halaman yang Anda cari tidak tersedia. Jika Anda tersesat dan butuh bantuan kami, hubungi SiCantik. </p>
        </div>
        <div class="missing__nav e-nav">
          <a href="https://wa.me/+628115216200" target="_blank" class="e-nav__link"></a>
        </div>
      </div>
      <!-- END Content -->
    </section>
